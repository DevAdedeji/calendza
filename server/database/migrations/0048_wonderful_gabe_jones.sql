...
ALTER TABLE "organizations" ADD COLUMN "hide_calendza_branding" boolean DEFAULT false NOT NULL;--> statement-breakpoint
...
--> statement-breakpoint
CREATE TRIGGER calendza_set_updated_at BEFORE UPDATE ON "organization_brand_logos"
FOR EACH ROW EXECUTE FUNCTION public.calendza_set_updated_at();
--> statement-breakpoint
CREATE TRIGGER calendza_set_updated_at BEFORE UPDATE ON "organization_event_templates"
FOR EACH ROW EXECUTE FUNCTION public.calendza_set_updated_at();
