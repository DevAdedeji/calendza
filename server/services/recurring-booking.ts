...
import { commonRecurringHostIds } from '@@/server/domain/recurrence'
import type { TeamSlot } from '@@/server/domain/team-availability'
...
import { teamSlotsFor } from '@@/server/services/team-booking'
