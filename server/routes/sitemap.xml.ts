...
export default defineEventHandler(async (event) => {
  ...
  const pages: SitemapPage[] = [
    ...
    { path: '/use-cases/consultants', priority: '0.8', changefreq: 'weekly' },
    { path: '/use-cases/small-business', priority: '0.8', changefreq: 'weekly' },
    { path: '/use-cases/paid-appointments', priority: '0.8', changefreq: 'weekly' },
    { path: '/use-cases/team-scheduling', priority: '0.8', changefreq: 'weekly' },
