...
export const productFeatureGroups: ProductFeatureGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Website embeds', summary: 'Let visitors book directly on your website with an inline embed or booking overlay.', icon: 'i-lucide-panels-top-left', to: '/features/booking-widget' },
